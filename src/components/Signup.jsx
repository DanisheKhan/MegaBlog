...
function Signup() {
  ...
  return (
    <div className="mt-5 flex items-center justify-center p-4">
      <div className="glass-container relative p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl shadow-black/30 max-w-md w-full">
        {/* Decorative Icon */}
        ...
        <div className="relative z-10 space-y-6">
          ...
          <form onSubmit={handleSubmit(createAccount)} className="space-y-6">
            ...
            <Button
              type="submit"
              className="flex items-center justify-center w-full py-3.5 bg-gradient-to-r from-purple-500 to-pink-500"
            >
